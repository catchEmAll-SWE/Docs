...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.8]{img/mining_pool.png}\\
    \caption{Mining Pool}
\end{figure}
La Mining Pool, attore secondario per la generazione del proof of work\textsubscript{G}. \\
...
\textbf{Attore primario:} WebApp.\\
\textbf{Attori secondari:} Mining Pool.\\
...
\paragraph{UC8.2 - Verifica Proof of Work\textsubscript{G}}
\textbf{Attore primario:} WebApp.\\
...
\subsubsection{UC7  - Mining Pool non disponibile}
\textbf{Attore primario:} WebApp.\\
