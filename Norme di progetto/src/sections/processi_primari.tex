...
\subsection{Sviluppo}
    ...
    Lo scopo di questa attività è quello di stilare tutti i requisiti che saranno necessari per la successiva fase di progettazione e quindi per lo sviluppo di un prodotto che risponda in maniera completa ai bisogni del proponente. \\
	...
	Lo scopo di questa attività è quello di individuare le varie caratteristiche che comporranno il prodotto richiesto dal proponente avendo come riferimento i requisiti definiti nel documento \textit{Analisi\_dei\_requisiti v 1.0.0}. Le varie caratteristiche verranno poi messe insieme per costruire una singola soluzione che rispetti i vari obiettivi di qualità del prodotto.
