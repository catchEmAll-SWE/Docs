...
\subsection{Sviluppo}
    ...
    \begin{itemize}
    	...
    	\begin{itemize}
    		\item \textbf{Laravel}: Framework php utilizzato per sviluppare il back-end e front-end del prodotto;
    		...
    		\item \textbf{SQLITE}: Libreria che implementa un DBMS SQL di tipo ACID incorporabile all'interno di applicazioni. Utilizzata per la creazione del database utilizzato dall'API;
    		\item \textbf{Python}: Linguaggio di programmazione utilizzato per lo sviluppo dello script per scontornare le immagini;
