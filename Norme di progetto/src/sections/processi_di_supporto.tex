...
\begin{itemize}
    \item \textbf{Assegnazione dell'appalto}: Con al suo interno i documenti \textit{lettera_candidatura.pdf}, \textit{preventivo\_ore\_costi\_rischi.pdf}, \textit{motivazione\_capitolati.pdf};
