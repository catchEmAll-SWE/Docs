...
Di seguito vengono illustrate le varie organizzazione dei repository:
\begin{itemize}
\item \textbf{catchEmAll-SWE/Docs} è la repository\textsubscript{G} contenente documentazione riguardante:
\begin{itemize}
    \item \textbf{Assegnazione dell'appalto}: Con al suo interno i documenti \textit{lettera\_candidatura.pdf}, \textit{preventivo\_ore\_costi\_rischi.pdf}, \textit{motivazione\_capitolati.pdf};
...
Allo scopo di eseguire in modo automatizzato l'inspection dei file è stato scritto un programma in python\textsubscript{G} che permette di verificare determinati elementi:
\begin{itemize}
