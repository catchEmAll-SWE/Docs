...
\begin{itemize}
    ...
    \item \textbf{Uso esterno}: Sono documenti di interesse a tutti gli stakeholder, ovvero \textit{Analisi dei requisiti\textsubscript{G}}, \textit{Verbali esterni}, \textit{Piano di progetto}, \textit{Piano di qualifica}, \textit{Glossario}.
\end{itemize}
