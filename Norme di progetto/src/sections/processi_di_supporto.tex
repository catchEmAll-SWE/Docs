...
\subsubsection{Struttura del repository\textsubscript{G}}
Di seguito viene data una lista di cartelle presenti nella repository\textsubscript{G} su Git:
\begin{itemize}
\item \textbf{catchEmAll-SWE/catchEmAll-Docs} è la repository\textsubscript{G} contenente documentazione riguardante:
\begin{itemize}
