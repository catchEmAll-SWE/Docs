...
\begin{itemize}
    \item \textbf{Logo dell'università}: Posizionato nella parte centrale alta della pagina, seguito dalla nomenclatura "Università degli  Studi di Padova";
    \item \textbf{Logo del gruppo}: Posizionato in centro, a seguito della nomenclatura dell'università;
...
I documenti che sono soggetti a modifiche periodiche sono dotati di un registro che ne memorizza lo storico. Impostato come segue:
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Intestazione}: In alto a sinistra il nome del gruppo \textit{Catch em All}, mentre in altro a destra il numero e nome della sezione in cui ci si trova;
    \item \textbf{Pie di pagina}: In basso sinistra il nome del documento e la sua versione attuale, mentre in basso a destra il numero della pagina in cui ci si trova insieme al numero di pagine complessive del documento.
\end{itemize}
