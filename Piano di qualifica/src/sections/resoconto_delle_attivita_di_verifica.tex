...
\subsection{Periodo di progettazione architetturale, codifica e validazione\textsubscript{G}}
...
Avendo invece un processo di verifica\textsubscript{G} ben strutturato, si sono rese necessarie alcune ore in meno per il ruolo di Verificatore rispetto a quanto preventivato.
...
\subsubsection{Verifica\textsubscript{G} del prodotto software}
...
\end{figure}
\subsubsubsection{Adeguatezza della complessità ciclomatica\textsubscript{G}}
\begin{figure}[H]
	\centering
