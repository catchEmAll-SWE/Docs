...
\subsubsubsection{Scopo}
Lo scopo del sesto sprint è quello di validare i documenti necessari alla revisione RTB e collaudare il Proof of Concept sviluppato. A seguito della validazione il \textit{Re} dovrà dare il consenso al rilascio dei prodotti.
\subsubsubsection{Durata}
